...
import type { PaletteKit, PaletteKitConfig, PaletteResolveOptions } from "./types/index.js";
...
function createResolveFunction<I extends string, PaletteOutput extends ColorOutput>(
...
>(config: PaletteKitConfig<I, PaletteOutput>): PaletteKit<I, PaletteOutput> {
  ...
  const intentRegistry = createIntentRegistry(config.intents as Record<I, IntentDefinition>);
