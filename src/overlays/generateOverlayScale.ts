...
import type { ColorHex, OverlayScale, Step } from "../types.js";
...
export function generateOverlayScale(): OverlayScale {
  const black: Record<Step, ColorHex> = {} as Record<Step, ColorHex>;
  const white: Record<Step, ColorHex> = {} as Record<Step, ColorHex>;
