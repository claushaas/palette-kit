...
Se você quiser, eu já posso transformar isso no **primeiro conjunto de tarefas executáveis** (tipo “Sprint 0 + Sprint 1”) e entregar também um **esqueleto de código TS** com os tipos e a primeira versão de `defaultRoles.ts` — mas mantendo incremental, para o Codex ir preenchendo sem tropeçar na própria ambição.
